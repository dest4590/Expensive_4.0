...
/**
 * A {@link ICommandArgument} is an immutable object representing one command
 * argument. It contains data on the index of
 * that argument, its value, and the rest of the string that argument was found
 * in
 * <p>
...
public interface ICommandArgument {
    ...
    /**
     * @return The index of this command argument in the list of command arguments
     * generated
     */
    int getIndex();
    ...
    /**
     * Gets an enum value from the enum class with the same name as this argument's
     * value
     * <p>
     * For example if you getEnum as an {@link Direction}, and this argument's value
     * is "up", it will return {@link
     * Direction#UP}
     *
     * @param enumClass The enum class to search
     * @return An enum constant of that class with the same name as this argument's
     * value
    ...
    /**
     * Tries to use a <b>stateless</b> {@link IArgParser} to parse this argument
    ...
    /**
     * Tries to use a <b>stated</b> {@link IArgParser} to parse this argument into
     * the specified class
     *
     * @param type The class to parse this argument into
     * @return An instance of the specified type
